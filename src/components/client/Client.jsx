...
import { getStoredClientName, logout } from "../../service/apiService";
...
const dummyBookings = [
  ...
  },
  {
    ...
    status: "pending",
    image:
      "https://images.unsplash.com/photo-1583939003579-730e3918a45a?q=80&w=200&h=200",
  },
];
      ...
      <main className="container py-8">
        ...
        <div className="mb-8 p-6 bg-white rounded-lg shadow">
          <div className="flex items-center justify-between">
            ...
            <button className="bg-black px-4 py-2 text-white rounded flex items-center gap-2">
